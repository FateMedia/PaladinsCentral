          ...
          foreach (explode('&', $_GET['_wp_http_referer']) as $coppia) {
            ...
            if($param[0]=='s' && $param[1]!='') { $filter_search =$param[1]; $filter.= "&amp;s=".htmlspecialchars($filter_search, ENT_QUOTES); ?>
              ...
              jQuery(document).ready(function($) {
                jQuery('#search_id-search-input').val(<?php echo json_encode($filter_search, JSON_HEX_TAG|JSON_HEX_APOS|JSON_HEX_QUOT|JSON_HEX_AMP); ?>);
              });
              //-->
              </script>
            <?php
       ...
       <form style="margin-top: 20px;" id="submissions-action" method="get" action="">
        ...
        <?php
            ...
            <span><label><?php _e("Page: ", 'accua-form-api'); ?></label><select name='pid' id='pid'>
              ...
              <span style="margin-left: 10px;"><label><?php _e("Year: ", 'accua-form-api'); ?></label><select name='year' id='year'>
              ...
              <span style="margin-left: 10px;"><label><?php _e("Month: ", 'accua-form-api'); ?></label><select name='month' id='month'>
              <option value="-1" ></option>
              <?php for($i = 1; $i <= 12; $i++){
                       echo "<option value='".$i."'";
                       if($filter_month==$i) {
